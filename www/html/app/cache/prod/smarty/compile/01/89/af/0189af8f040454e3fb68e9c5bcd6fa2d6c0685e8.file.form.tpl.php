<?php /* Smarty version Smarty-3.1.19, created on 2017-11-03 21:38:40
         compiled from "/var/www/html/adminD/themes/default/template/controllers/request_sql/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:22356456159fcd3d01ecb52-77177583%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0189af8f040454e3fb68e9c5bcd6fa2d6c0685e8' => 
    array (
      0 => '/var/www/html/adminD/themes/default/template/controllers/request_sql/helpers/form/form.tpl',
      1 => 1509697773,
      2 => 'file',
    ),
    'a4e7468350b38074eeee73dcef98a045c260138e' => 
    array (
      0 => '/var/www/html/adminD/themes/default/template/helpers/form/form.tpl',
      1 => 1509697773,
      2 => 'file',
    ),
    '4d4fdf397a9e22279904ce963af52ef286403d0d' => 
    array (
      0 => '/var/www/html/adminD/themes/default/template/helpers/form/form_group.tpl',
      1 => 1509697773,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '22356456159fcd3d01ecb52-77177583',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_59fcd3d22e8023_58997645',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_59fcd3d22e8023_58997645')) {function content_59fcd3d22e8023_58997645($_smarty_tpl) {?><?php if (!is_callable('smarty_function_counter')) include '/var/www/html/vendor/prestashop/smarty/plugins/function.counter.php';
?>
...
$_tpl_stack[] = $_smarty_tpl;
 $_smarty_tpl = $_smarty_tpl->setupInlineSubTemplate('helpers/form/form_group.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0, '22356456159fcd3d01ecb52-77177583');
content_59fcd3d1939154_97379575($_smarty_tpl);
...
<div class="row">
	<div class="col-lg-3">
		<div class="panel">
			<h3><i class="icon-list"></i> <?php echo smartyTranslate(array('s'=>'List of MySQL Tables','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
</h3>
...
"><?php echo $_smarty_tpl->tpl_vars['table']->value;?>
			...
			<div class="form-group">
				<button type="button" id="add_table" class="btn btn-default"><i class="icon-plus-sign"></i> <?php echo smartyTranslate(array('s'=>'Add table name to SQL query','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
</button>
			</div>
		</div>
	</div>
	<div class="col-lg-9">
		<div class="panel">
			<h3><i class="icon-list"></i> <?php echo smartyTranslate(array('s'=>'List of attributes for this MySQL table','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
</h3>
			<div id="listAttributes">
				<div class="alert alert-warning"><?php echo smartyTranslate(array('s'=>'Please choose a MySQL table','d'=>'Admin.Advparameters.Notification'),$_smarty_tpl);?>
</div>
			</div>
		</div>
	</div>
...
',
					...
					var html = "<table class='table'>";
						html += "<thead>";
							html += "<tr>";
								...
								html += "<th class=\"fixed-width-md\"><span class=\"title_box\"><?php echo smartyTranslate(array('s'=>'Type','d'=>'Admin.Global'),$_smarty_tpl);?>
</span></th>";
								html += "<th class=\"fixed-width-md\"><span class=\"title_box\"><?php echo smartyTranslate(array('s'=>'Action','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
</span></th>";
							html += "</tr>";
						html += "</thead>";
						html += "<tbody>";
						for (var i=0; i < data.length; i++)
						{
							html += "<tr>";
								...
								html += "<td><button type=\"button\" class=\"btn btn-default\" onclick=\"javascript:AddRequestSql('"+data[i].Field+"');\"><?php echo smartyTranslate(array('s'=>'Add attribute to SQL query','d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
</button></td>";
							html += "</tr>";
						}
						html += "</tbody>";
		...
		$('#add_table').click(function(){
			...
			if (!table)
				jAlert("<?php echo smartyTranslate(array('s'=>'Please choose a table.','js'=>1,'d'=>'Admin.Advparameters.Feature'),$_smarty_tpl);?>
");
			else
				AddRequestSql(table);
		});
...
<?php }?>
<?php }} ?>
<?php /* Smarty version Smarty-3.1.19, created on 2017-11-03 21:38:41
         compiled from "/var/www/html/adminD/themes/default/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_59fcd3d1939154_97379575')) {function content_59fcd3d1939154_97379575($_smarty_tpl) {?>
